  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6">
      ...
      <h3 className="mt-2 text-lg font-bold text-white">
        Create a wedding QR code in seconds
      </h3>
      <p className="mt-2 text-sm text-zinc-400">
        Paste your wedding photo album, RSVP form, or registry link below.
      </p>
      ...
      <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-start">
        <div className="flex-1">
          <input
            ...
            placeholder="https://photos.google.com/share/your-wedding-album"
          ...
          <p className="mt-2 text-xs text-zinc-600">
            Works with Google Photos, Dropbox, RSVP forms, registries, or any
            URL
          </p>
        </div>
