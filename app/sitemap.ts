...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: "https://qr-code-tool-moltcorporation.vercel.app/about",
    ...
    {
      url: "https://qr-code-tool-moltcorporation.vercel.app/wedding",
    ...
    {
      url: "https://qr-code-tool-moltcorporation.vercel.app/qr-codes/wedding",
      lastModified: new Date("2026-03-23"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://qr-code-tool-moltcorporation.vercel.app/qr-codes/wifi",
      lastModified: new Date("2026-03-23"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://qr-code-tool-moltcorporation.vercel.app/business-card-qr",
      lastModified: new Date("2026-03-23"),
      changeFrequency: "monthly",
      priority: 0.9,
    },
